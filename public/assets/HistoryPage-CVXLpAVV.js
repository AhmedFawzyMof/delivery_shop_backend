...
import { f as M } from "./Header.vue_vue_type_script_setup_true_lang-DoQDjMy6.js";
import { b as j, _ as O } from "./auth-BOWgCVVb.js";
import { _ as D } from "./Input.vue_vue_type_script_setup_true_lang-DEP3HyZt.js";
import { _ as A } from "./index-cBp-nCgD.js";
import {
  d as E,
  f as d,
  C as H,
...
const Z = { class: "p-6 space-y-8", dir: "rtl" },
  ...
  ie = { class: "font-bold text-primary" },
  me = { class: "ml-1 capitalize" },
  ...
  Re = E({
    ...
    setup(be) {
      const x = d([]),
        ...
        p = d(1),
        B = d(50),
        F = H(() => Math.ceil(g.value.sum_of_orders / B.value)),
        C = async () => {
          if (!c.value || !f.value) {
          ...
          try {
            const o = await j.get(
              `/orders?from=${c.value}&to=${f.value}&page=${p.value}`
            );
        ...
        I = async () => {
          try {
            const o = await j.get(
              `/orders?from=${c.value}&to=${f.value}&status=true&page=${p.value}`
            );
      ...
      R(async () => {
        ...
        (c.value = o), (f.value = o), await C(), await I();
      });
      function L(o) {
        switch (o) {
          case "preparing":
                ...
                a("div", ae, [
                  t(s(y), null, {
                    default: l(() => [
                        ...
                        },
                        {
                          default: l(() => [
                            t(
                              ...
                              {
                                default: l(() => [
                                  ...(e[7] || (e[7] = [m("عدد الطلبات", -1)])),
                                ]),
                                _: 1,
                              }
                            ),
                            t(s($), { class: "h-4 w-4 text-muted-foreground" }),
                          ]),
                          _: 1,
                        }
                      ),
                      t(s(h), null, {
                        default: l(() => [
                          a("div", le, n(g.value.sum_of_orders), 1),
                        ]),
                        _: 1,
                      }),
                    ]),
                  ...
                  t(s(y), null, {
                    default: l(() => [
                          ...
                          default: l(() => [
                            t(
                              ...
                              { class: "text-sm font-medium" },
                              {
                                default: l(() => [
                                  ...(e[8] ||
                                    (e[8] = [m(" عدد الطلبات المكتملة ", -1)])),
                                ]),
                                _: 1,
                              }
                            ),
                            t(s(W), { class: "h-4 w-4 text-muted-foreground" }),
                          ]),
                          _: 1,
                        }
                      ),
                      t(s(h), null, {
                        default: l(() => [
                          a("div", oe, n(g.value.sum_of_completed_orders), 1),
                          e[9] ||
                            (e[9] = a(
                              "p",
                                ...
                                _(
                                  ...
                                  [
                                    a("div", ne, [
                                      a("div", ue, [
                                        a("div", de, [
                                          a("span", ie, "#" + n(r.order_id), 1),
                                          t(
                                            s(A),
                                            { class: J(U(r.order_status)) },
                                            {
                                              default: l(() => [
                                                (u(),
